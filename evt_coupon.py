...
def main():
    ...
    with open('task.json', 'r') as json_file:
        ...
        for data in task_data:
                ...
                try:
                    ...
                    with open('task_log.csv', 'a', newline='', encoding='utf-8') as csvfile:
                        ...
                        writer.writerow({
                            ...
                            'retmsg': response_json.get('retMsg')
                        })
                        # 打印写入的内容
                        print(f"写入数据: {coupon}, {hiveid}, {server}, {current_time}, {response_json.get('retCode')}, {response_json.get('retMsg')}")
                        # 确保所有的文件写入操作都在 with 语句的代码块内部完成
                    #创建history.csv文件
                    ...
                    with open('history.csv', 'a', newline='') as csvfile:
                        ...
                        if response_json.get('retCode') == '100':
                            ...
                            with open('Reward_swq.json', 'r', encoding='utf-8') as json_file:
                                ...
                                for item in reward_data:
                                    ...
                                    # 打印写入的内容
                                    print(f"自动领取: {coupon}, {hiveid}, {server}, {current_time}")
            ...
            #打印延迟时间
            print("延迟时间:", random.uniform(15, 120))
